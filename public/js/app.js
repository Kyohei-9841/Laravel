 ...
 */
// require('./bootstrap');
__webpack_require__(/*! ./pages/admin-home */ "./resources/js/pages/admin-home.js");

__webpack_require__(/*! ./pages/approval */ "./resources/js/pages/approval.js");

__webpack_require__(/*! ./pages/camera */ "./resources/js/pages/camera.js");
...
var FORM = $("#uplord-form"); // set form or other element here

var TYPES = ["input[type=text]"]; // set which elements get targeted by the focus

var FOCUS = $("#focus"); // focus element
...
function position(e) {
  ...
  var offset_left = input_offset_left - card_offset_left; // get position
...
FORM.find(TYPES.join()).each(function (i) {
  ...
  $(this).focus(function () {
    el = $(this); // adapt size/position when resizing browser
...
$(function () {
  ...
  $('#pic').change(function () {
    ...
    reader.onload = function (e) {
      ...
      image.onload = function () {
        ...
        var ctx = canvas[0].getContext('2d'); // canvasに既に描画されている画像をクリア

        ctx.clearRect(0, 0, width, height); // canvasにサムネイルを描画

        ctx.drawImage(image, 0, 0, image.width, image.height, 0, 0, width, height); // canvasからbase64画像データを取得
  ...
  $('#form-submit').click(function () {
    console.log("ここは１"); // ファイルが指定されていなければ何も起こらない
...
__webpack_require__(/*! /Users/kunoyouhei/work/app/code/Laravel/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/kunoyouhei/work/app/code/Laravel/resources/sass/app.scss */"./resources/sass/app.scss");
