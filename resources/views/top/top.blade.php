    ...
    <header id="home">
        <div class="container-fluid">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-xs-10">
                        <a href="#" class="thumbnail logo">
                            <img src="{{ asset('images/your_logo.png') }}" alt="" class="img-responsive">
                        </a>
                    </div>
                ...
                <div class="jumbotron">
                    <p>Make fishing more fun</p>
                    <h2>{{ config('app.name', 'Laravel') }}</h2>
                    {{-- <p>This is a simple hero unit, a simple jumbotron-style component for<br>
calling extra attention to featured content or information.</p>
                    <p> --}}
                        @guest
                            <a class="btn btn-primary btn-lg border-radius" href="{{ route('register') }}" role="button">Entry</a>
                            <a class="btn btn-danger btn-lg border-radius" href="{{ route('login') }}" role="button">Login</a>
                        @else
                            @if (Auth::user()->role == 1)
                                <a class="btn btn-primary btn-lg border-radius" href="{{ route('home') }}" role="button">User Page</a>
                            @elseIf (Auth::user()->role == 0)
                                <a class="btn btn-primary btn-lg border-radius" href="{{ route('home') }}" role="button">User Page</a>
                            @endif
                            <a class="btn btn-danger btn-lg border-radius" href="{{ route('logout') }}" role="button" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Logout</a>
